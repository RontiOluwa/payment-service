 ...
 * tests exercise only the business logic (creation, retrieval, and
 * state-machine transitions), with no real Redis connection, no real
 * storage, and no real worker involved.
 */
